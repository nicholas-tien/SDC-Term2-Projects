...
#ifndef SDC_PF_HELP_FUNCTION_H
#define SDC_PF_HELP_FUNCTION_H
...
struct LandmarkObs {
    ...
    double x;     // Local (vehicle coordinate) x position of the landmark observation [m]
    double y;     // Local (vehicle coordinate) y position of the landmark observation [m]
};
...
inline bool read_map_data(std::string filename, Map& map) {
    ...
    // Daclare singe line of the map file
    std::string line_map;
    ...
    while (getline(in_file_map, line_map)){
        ...
        // Daclare landmark values and ID
        ...
        // Add to landmark list of the map
